...
document.querySelector('#asteroid').innerHTML = asteroid.close_approach_data[0].miss_distance.miles;
document.querySelector('#more-info').innerHTML = asteroid.orbital_data.orbit_class.orbit_class_description;
document.querySelector('#even-more-info').innerHTML = asteroid.estimated_diameter.miles.estimated_diameter_max;

document.querySelector('#helen').innerHTML = "The asteroid named " + asteroid.name + " is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + " miles wide, and will miss striking Earth by approximately " +  asteroid.close_approach_data[0].miss_distance.miles + " miles.";

document.querySelector('#link').innerHTML =  '<a href="' + asteroid.links.self + '">Asteroid Link</a>';